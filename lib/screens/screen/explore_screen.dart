...
import 'package:Bloomee/screens/widgets/language_filter_chips.dart';
import 'package:Bloomee/screens/widgets/skeleton_card_view.dart';
      ...
      child: MultiBlocProvider(
        ...
        child: BlocListener<SettingsCubit, SettingsState>(
          listenWhen: (previous, current) =>
              previous.contentLanguages != current.contentLanguages ||
              previous.displayLanguage != current.displayLanguage,
          listener: (context, state) {
            yTMusicCubit.fetchYTMusic();
          },
          child: Scaffold(
                      ...
                      [
                        ...
                        BlocBuilder<YTMusicCubit, YTMusicCubitState>(
                          builder: (context, state) {
                            ...
                            // Show skeleton if loading or no content in body
                            final hasContent = state.ytmData['body'] != null &&
                                (state.ytmData['body'] as List).isNotEmpty;
